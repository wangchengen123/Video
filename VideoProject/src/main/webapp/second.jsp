...
<body class="w100" style="padding-top: 0px;">
	...
	<div class="container">
		...
		<a target="_blank"
			href="${pageContext.request.contextPath }/Background/后台首页.jsp"><img
		...
		<div class="container">
			...
			<div class="course-info">
				<table cellspacing="10">
					<tbody>
						<tr>
							<td colspan="2"><a href="${pageContext.request.contextPath }/pages/CourseShow.jsp"> <img
									src="${pageContext.request.contextPath }/z/html5.jpg" alt=""
									class="image scale" draggable="false">
									<div class="headline">
										<span>Web前端教程</span> <img
											src="${pageContext.request.contextPath }/z/arrow.png" alt="">
									</div>
							</a></td>
							<td>
								<!--上线时修改id--> <a> <img
									src="${pageContext.request.contextPath }/z/ui.jpg" alt=""
									class="image scale" draggable="false">
									<div class="headline">
							...
							<td rowspan="2" class="one_three"><a class="opacity5"> <img
									src="${pageContext.request.contextPath }/z/java.jpg" alt=""
						...
						<tr>
							<td><a class="opacity5"> <img
									src="${pageContext.request.contextPath }/z/bigdata.jpg" alt=""
									class="image" draggable="false">
									<div class="headline">
										<span>大数据教程</span> <img
											src="${pageContext.request.contextPath }/z/arrow.png" alt="">
							...
							<td colspan="2"><a> <img
									src="${pageContext.request.contextPath }/z/python.jpg" alt=""
									class="image scale" draggable="false">
									<div class="headline">
						...
						<tr>
							<td colspan="2"><a> <img
									src="${pageContext.request.contextPath }/z/php.jpg" alt=""
									class="image scale" draggable="false">
									<div class="headline">
										<span>PHP教程</span> <img
											src="${pageContext.request.contextPath }/z/arrow.png" alt="">
							...
							<td colspan="2" class="three_two"><img
								src="${pageContext.request.contextPath }/z/qidai.jpg" alt=""
								class="image" draggable="false">
		...
		<div class="mask_content">
			...
			<div class="mask_content_body">
				<form  action="login.do">
					<h3>快速登录</h3>
					<input  placeholder="请输入邮箱" name="accounts"
						type="email"> <input 
					...
					<p class="error-massage" style="color: red;">${msg }</p>
	...
	<div class="mask hidden" id="reg">
		<div class="mask_content">
			...
			<div class="mask_content_body">
				<form id="regForm" action="user/add">
					<h3>新用户注册</h3>
