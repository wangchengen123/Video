...
<link rel="stylesheet" href="${pageContext.request.contextPath }/js/profile.css">
	...
	<menu>
		<div class="container clearfix">
			<ul class="clearfix f_left">
				<li><a href="${pageContext.request.contextPath }/Background/后台首页.jsp">首页</a></li>

				<li class="menu_active"><a href="${pageContext.request.contextPath }/pages/CelebrityCentre.jsp">个人中心</a></li>
			</ul>

			<div id="user_bar">
				<a> <img id="avatar" src="${pageContext.request.contextPath }/z/avatar_lg.png" alt=""
					width="30px;">




				</a> <a id="lay_out" href="${pageContext.request.contextPath }/index.jsp">退出</a>
			</div>
		</div>
	</menu>
	</header>
	...
	<div class="container">
		...
		<div id="profile_tab">
			<ul class="profile_tab_header f_left clearfix">
				<li><a href="${pageContext.request.contextPath }/pages/ModifiedData.jsp">更改资料</a></li>
				<li class="profile_tab_line">|</li>
				<li><a href="${pageContext.request.contextPath }/pages/PortraitEditor.jsp">更改头像</a></li>
				<li class="profile_tab_line">|</li>
				<li><a href="${pageContext.request.contextPath }/pages/ChangePassword.jsp">密码安全</a></li>
			</ul>
