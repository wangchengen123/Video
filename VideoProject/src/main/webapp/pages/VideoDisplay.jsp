...
<link rel="icon" href="http://localhost:8080/Voids/static/z/favicon.png"
	type="image/png">
<link href="${pageContext.request.contextPath }/js/video-js.css" rel="stylesheet" type="text/css">
...
<body class="w100" style="padding-top: 0px;">
	...
	<div class="container">
		...
		<div id="userBlock" style="float: right">
			...
			<a href="${pageContext.request.contextPath }/pages/CelebrityCentre.jsp">${user.accounts}</a>
		</div>
		...
		<a onclick="JavaScript:addFavorite2()"><img
			src="${pageContext.request.contextPath }/z/sc.png" draggable="false">加入收藏</a> <a
			target="_blank"><img src="${pageContext.request.contextPath }/z/we.png" draggable="false">后台管理</a>
		<a class="color_e4"><img src="${pageContext.request.contextPath }/z/phone.png"
					...
					<div class="v-intro">
						<div class="left">
							<video id="videoPlayer"
								src="${pageContext.request.contextPath }/mp/2.mp4"
						...
						<div class="right">
							...
							<div class="avatar">
								<span
									style="background-image: url(${pageContext.request.contextPath}/speakerimg/3.jpg
)"></span>
								<p>
									<b>讲师：赵桂丹</b><br>
			...
			<div class="catalog">
				<div class="container">
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								alt="">433</span> <span class="duration"><img
								src="${pageContext.request.contextPath }/z/player.png" alt="">562</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">596</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">1374</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">1692</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">1699</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">409</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">2112</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">1997</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">1569</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">2179</span>
						</div>
					</div>
					...
					<div class="chapter">
						...
						<div class="v-info">
							<span class="count"><img src="${pageContext.request.contextPath }/z/count.png"
								...
								src="${pageContext.request.contextPath }/z/player.png" alt="">2134</span>
						</div>
					</div>
	...
	<footer>
	<ul>
		<li><img src="${pageContext.request.contextPath }/z/footer_logo.png" alt=""
			draggable="false"></li>
		<li class="mt25">
			<h3>各校区地址</h3>
			<ul>
		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei"><br>
					<div>
						<img class="weixin" src="${pageContext.request.contextPath }/z/a.png" alt=""
							draggable="false"> <img class="weibo"
							src="${pageContext.request.contextPath }/z/a_002.png" alt="" draggable="false">
					</div></li>
			</ul>
		</li>
	</ul>
