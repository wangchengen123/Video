...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/z/base.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/z/css.css">
...
<body class="w100" style="padding-top: 0px;">
	...
	<div class="container">
		...
		<a onclick="JavaScript:addFavorite2()"><img
			src="${pageContext.request.contextPath }/z/sc.png" draggable="false">加入收藏</a>
		<a target="_blank"><img
			src="${pageContext.request.contextPath }/z/we.png" draggable="false">后台管理</a>
		<a class="color_e4"><img
			src="${pageContext.request.contextPath }/z/phone.png"
	...
	<div id="app">
		<!--banner图-->
		<div class="banner">
			<img alt="" src="${pageContext.request.contextPath }/z/banner-1.jpg"
				...
				<div class="section">
					...
					<ul>
						...
						<li class="section-main" onclick="getVideo(217)">
							<div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/1.jpg)"></div>
							<p><a href="${pageContext.request.contextPath }/pages/VideoDisplay.jsp">前端开发环境搭建</a></p>
							<div class="classify-v-info">
								<span class="count" title="观看次数"><img
									src="${pageContext.request.contextPath }/z/count.png" alt="">433</span>
				...
				<div class="section">
					...
					<ul>
						...
						<li class="section-main" onclick="getVideo(245)">
							<div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/2.jpg)"></div>
							<p><a href="">Git的安装及配置</a></p>
							<div class="classify-v-info">
								<span class="count" title="观看次数"><img
									src="${pageContext.request.contextPath }/z/count.png" alt="">208</span>
								<span class="duration" title="视频时长"><img
									src="${pageContext.request.contextPath }/z/player.png" alt="">320</span>
							</div>
						</li>
				...
				<div class="section">
					...
					<ul>
						...
						<li class="section-main" onclick="getVideo(224)">
							<div class="thum" style="background-image: url(${pageContext.request.contextPath}/videoimg/3.jpg)"></div>
							<p><a href="">React快速体验-组件</a></p>
							<div class="classify-v-info">
								<span class="count" title="观看次数"><img
									src="${pageContext.request.contextPath }/z/count.png" alt="">191</span>
								<span class="duration" title="视频时长"><img
									src="${pageContext.request.contextPath }/z/player.png" alt="">907</span>
							</div>
						</li>
		...
		<ul>
			<li><img
				src="${pageContext.request.contextPath }/z/footer_logo.png" alt=""
				draggable="false"></li>
			<li class="mt25">
				<h3>各校区地址</h3>
				<ul>
			...
			<li class="mt25">
				...
				<ul id="foo_icon">
					...
					<li class="erwei"><br>
						<div>
							<img class="weixin"
								src="${pageContext.request.contextPath }/z/a_002.png" alt=""
								draggable="false"> <img class="weibo"
								src="${pageContext.request.contextPath }/z/a.png" alt=""
								draggable="false">
						</div></li>
				</ul>
			</li>
		...
		<div class="mask hidden" id="login">
			<div class="mask_content">
				<div class="mask_content_header">
					<img src="${pageContext.request.contextPath }/z/logo.png" alt=""
						class="ma">
				</div>
