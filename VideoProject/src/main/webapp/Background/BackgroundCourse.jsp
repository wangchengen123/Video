			...
			<table class="table table-bordered table-hover"
				...
				<tbody>
					...
					<tr>
						...
						<td>Web前端入门小项目</td>
						<td
							style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">适合无编程基础但想学H5前端开发的同学入门学习，也适合UI、Java、PHP等其他学科学员预习或练习。本课程通过新闻页面、个人主页、个人简历、场景秀等多个项目案例由浅入深以项目实战的方式让同学们体验到前端开发乐趣。本课程突出实战，如果希望深入学习课程中涉及到的知识可报名学习智游前端开发课程。</td>
						<td><a>✎</a></td>
					...
					<tr>
						...
						<td>前端开发与Git入门</td>
						<td
							style=" overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">Git是一款免费、开源的分布式版本控制系统，用于敏捷高效地处理任何或小或大的项目。经过本章课程学习你将轻松入门，学会使用Git管理自己的源代码，让自己的开发之路井井有条，想进一步学习Git进阶部分的同学可报名智游前端开发课程。</td>
						<td><a>✎</a></td>
					...
					<tr>
						...
						<td
							style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">适合有一定HTML+JS基础、想学习React的同学。本课程循序渐进、浅显易懂，非常适合React入门学习。想进一步学习和使用React进行开发的同学可以报名智游前端开发课程。</td>
						<td><a>✎</a></td>
					...
					<tr>
						...
						<td>UI基础入门</td>
						<td
							style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">适合无设计基础但想学UI设计的同学学习。本课程零基础入门，扎实的软件基础、高端的图形创意、资深产品经理的面对面授课尽在智游UI设计课程，希望成为全能设计师的你可报名智游UI设计课程。</td>
						<td><a>✎</a></td>
					...
					<tr>
						...
						<td>Python编程零基础入门</td>
						<td
							style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">适合无编程基础但想学Python的同学学习。本课程完全零基础入门，如果希望深入学习Python开发可报名学习智游Python企业开发课程。</td>
						<td><a>✎</a></td>
						<td><a onclick="deletee(&#39;11&#39;)">X</a></td>
					</tr>

					<tr>
						<td colspan="2"><font>总共6条,当前第1页</font> 
						<a href="">1</a>&gt;
