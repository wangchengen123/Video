    ...
    <c:forEach items="${lists }" var="d">
	     <tr >
            ...
            <td style="vertical-align:middle;">
            	<fmt:formatDate value="${d.time }" pattern="yyyy-MM-dd HH-mm-SS"/>
            </td>
            <td style="vertical-align:middle;">${d.section.seccoName }</td>
            <td style="vertical-align:middle;"><a href="<c:url value="/doctor/sele?id=${d.id }"/>">详情>>></a>&nbsp;&nbsp;&nbsp;
            <a href="<c:url value="/doctor/select?id=${d.id }"/>">更改</a></td>
        </tr>
	</c:forEach>
  </table>
